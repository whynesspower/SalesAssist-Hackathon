...
const TermsConditions = () => {
  return (
    <div>
      ...
      <p>Welcome to License War!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of License War's Website, located at https://license-war.whynesspower.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use License War if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing License War, you agreed to
        use cookies in agreement with the License War's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, License War and/or its licensors own the
        intellectual property rights for all material on License War. All
        intellectual property rights are reserved. You may access this from
        License War for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from License War</li>
        <li>Sell, rent or sub-license material from License War</li>
        <li>Reproduce, duplicate or copy material from License War</li>
        <li>Redistribute content from License War</li>
      </ul>

      <p>
        This Agreement shall begin on the date hereof. Our Terms and Conditions
        were created with the help of the{" "}
        <a href="https://seomagnifier.com/">Terms and Conditions Generator</a>.
      </p>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        License War does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of License War,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, License War shall not be
      ...
      <p>
        License War reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant License War a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of License War; and (d) the link
      ...
      <p>
        ...
        e-mail to License War. Please include your name, your organization name,
      ...
      <p>
        No use of License War's logo or other artwork will be allowed for
