    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to License War.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to License War, accessible from{" "}
            <a
              href="https://license-war.whynesspower.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://license-war.whynesspower.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://x.com/whyesspower"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://x.com/whyesspower
          </a>
        </li>
      </ul>
    </div>
